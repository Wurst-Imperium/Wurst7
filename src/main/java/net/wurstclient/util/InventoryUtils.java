...
public enum InventoryUtils
{
	...
	{
		return indexOf(stack -> stack.getItem() == item, 36, false);
	}
	
	public static int indexOf(Item item, int maxInvSlot)
	{
		return indexOf(stack -> stack.getItem() == item, maxInvSlot, false);
	}
	
	public static int indexOf(Item item, int maxInvSlot, boolean includeOffhand)
	{
		return indexOf(stack -> stack.getItem() == item, maxInvSlot,
			includeOffhand);
	}
