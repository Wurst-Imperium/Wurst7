...
/**
 * Represents a list of friends, along with methods to save or load the list
 * from disk.
 */
public class FriendsList
{
	...
	/**
	 * Save all friends in the list to the file at friendsFile. This file will
	...
	/**
	 * Loads all friends from file, and puts them in the list. If the file does
