...
/**
 * Renders lines and tracers for entities' ranged weapons. Call the post method to do so.
 * @author Admin
 *
 */
public class TrajectoryRenderer implements RenderListener {
	...
	/**
	 * Post a request to render the trajectory for an entity's held ranged weapon.
	 * Call this from RenderWorldLast; doing so from update will cause flicker.
	 * Colors are entered as hex RGBA values.
	 * @param entity Entity to render ranged weapon from.
	 * @param style Render lines, boxes, or both?
	 * @param defaultcolor Normal color to render.
