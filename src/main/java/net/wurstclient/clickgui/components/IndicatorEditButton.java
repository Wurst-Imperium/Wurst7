...
import net.wurstclient.clickgui.screens.EditIndicatorListScreen;
import net.wurstclient.settings.IndicatorListSetting;

public final class IndicatorEditButton extends Component
{
	private final IndicatorListSetting setting;
	private int buttonWidth;
	
	public IndicatorEditButton(IndicatorListSetting setting)
	{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		WurstClient.MC.openScreen(
			new EditIndicatorListScreen(WurstClient.MC.currentScreen, setting));
	}
		...
		float partialTicks)
	{
		...
		TextRenderer fr = WurstClient.MC.textRenderer;
		String text = setting.getName() + ": " + setting.getIndicators().size();
