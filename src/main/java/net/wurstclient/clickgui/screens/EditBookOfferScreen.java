...
public final class EditBookOfferScreen extends Screen
{
		...
		float partialTicks)
	{
		...
		helper.drawTextWithShadow(tr, "Level:", 0, 0, 0xf0f0f0);
		helper.drawTextWithShadow(tr, "Max price:", 0, 16, 0xf0f0f0);
		
		if(alreadyAdded && offerToSave != null)
		{
			String errorText = offerToSave.getEnchantmentNameWithLevel()
				+ " is already on your list!";
			helper.drawTextWithShadow(tr, errorText, 0, 32, 0xff5555);
		}
