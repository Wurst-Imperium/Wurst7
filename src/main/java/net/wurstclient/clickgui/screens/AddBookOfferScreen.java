...
public final class AddBookOfferScreen extends Screen
{
	...
	public void init()
	{
		...
		levelField = new TextFieldWidget(client.textRenderer, width / 2 - 32,
			height - 74, 28, 12, new LiteralText(""));
		addChild(levelField);
		...
		priceField = new TextFieldWidget(client.textRenderer, width / 2 - 32,
			height - 58, 28, 12, new LiteralText(""));
		addChild(priceField);
		...
		addButton(levelPlusButton = new ButtonWidget(width / 2 + 2, height - 74,
			20, 12, new LiteralText("+"), b -> updateLevel(1, true)));
		...
		addButton(pricePlusButton = new ButtonWidget(width / 2 + 2, height - 58,
			20, 12, new LiteralText("+"), b -> updatePrice(1, true)));
		...
		addButton(addButton = new ButtonWidget(width / 2 - 102, height - 28,
			100, 20, new LiteralText("Add"), b -> {
