	...
	implements UpdateListener, RenderListener 
{
	...
	private final CheckboxSetting invertList = new CheckboxSetting("Invert List",
			"If enabled, only searches for listed blocks instead of searching for any blocks not listed.", false);

	private final SliderSetting radius = new SliderSetting("Search Radius",
			"Radius to search for blocks from list. Makes BaseFinder exponentially laggier.",
			64, 0, 128, 16, ValueDisplay.INTEGER.withSuffix(" blocks"));
