	...
	implements UpdateListener, RenderListener
{
	private final BlockListSetting naturalBlocks = new BlockListSetting(
		...
		"minecraft:coarse_dirt", "minecraft:cobweb", "minecraft:cornflower",
		"minecraft:dandelion", "minecraft:dark_oak_leaves",
		"minecraft:dark_oak_log", "minecraft:dead_bush", "minecraft:diamond_ore",
		"minecraft:diorite", "minecraft:dirt", "minecraft:emerald_ore",
		"minecraft:fern", "minecraft:gold_ore", "minecraft:granite",
		...
		"minecraft:peony", "minecraft:pink_tulip", "minecraft:podzol",
		...
		"minecraft:sandstone", "minecraft:seagrass", "minecraft:snow",
		"minecraft:spawner", "minecraft:spruce_leaves", "minecraft:spruce_log",
		"minecraft:stone", "minecraft:sunflower", "minecraft:tall_grass",
		"minecraft:tall_seagrass", "minecraft:vine", "minecraft:water",
