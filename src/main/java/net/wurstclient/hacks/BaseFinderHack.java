	...
	implements UpdateListener, RenderListener
{
	private final BlockListSetting naturalBlocks = new BlockListSetting(
		...
		"minecraft:azure_bluet", "minecraft:bedrock", "minecraft:beehive",
		...
		"minecraft:budding_amethyst", "minecraft:bush", "minecraft:calcite",
		"minecraft:cave_air", "minecraft:clay", "minecraft:coal_ore",
		"minecraft:cobweb", "minecraft:copper_ore", "minecraft:cornflower",
		"minecraft:dandelion", "minecraft:dark_oak_leaves",
		"minecraft:dark_oak_log", "minecraft:dead_bush", "minecraft:deepslate",
		...
		"minecraft:lava", "minecraft:leaf_litter", "minecraft:lilac",
		"minecraft:lily_of_the_valley", "minecraft:lily_pad",
		"minecraft:magma_block", "minecraft:medium_amethyst_bud",
