...
public final class TillauraHack extends Hack implements UpdateListener
{
	...
	{
		ShapeType type = RayTraceContext.ShapeType.COLLIDER;
		FluidHandling fluid = RayTraceContext.FluidHandling.NONE;
		
		RayTraceContext context =
			new RayTraceContext(from, to, type, fluid, MC.player);
