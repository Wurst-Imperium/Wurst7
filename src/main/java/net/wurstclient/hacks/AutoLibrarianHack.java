...
public final class AutoLibrarianHack extends Hack
    ...
    public final CheckboxSetting enableGuiLessTradeDetection = new CheckboxSetting("GUI-less Trade Detection",
    ...
    public void onUpdate() {
        ...
        if (enableGuiLessTradeDetection.isChecked()) {
            if (MerchantPacket.packet == null || MerchantPacket.lastEntityId == 0) {
                return;
            }
            ...
            BookOffer bookOffer = findEnchantedBookOffer(MerchantPacket.packet.getOffers());
            ...
            if (lockInTrade.isChecked()) {
                ChatUtils.warning("Lock In Trade is not available in GUI-less Trade Detection mode!");
            }
