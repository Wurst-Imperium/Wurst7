...
public class ProfilesScreen extends Screen
{
    ...
    public void init()
    {
        listGui = new ListGui(client, this, profiles.listProfiles());
        ...
        addDrawableChild(new ButtonWidget(width / 2 - 154, height - 48, 100, 20,
                new LiteralText("New Profile"), b -> WurstClient.setScreen(
    ...
    {
        Util.getOperatingSystem().open(profiles.getProfilesFolder().toFile());
    }
                       ...
                       float partialTicks)
    {
        ...
        drawCenteredText(matrixStack, client.textRenderer, "Profiles",
                width / 2, 12, 0xffffff);
    ...
    private static class ListGui extends ListWidget
    {
        ...
        public ListGui(MinecraftClient mc, Screen screen,
                       ArrayList<Path> list)
        {
