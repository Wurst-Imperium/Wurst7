...
public class MCGameOptions {
    ...
    public double getGamma() {
        return this.MC.options.getGamma().getValue();
    }

    public double getMouseSensitivity() {
        return this.MC.options.getMouseSensitivity().getValue();
    }

    public boolean getIsFullscreen() {
        return this.MC.options.getFullscreen().getValue();
    }
    ...
    public void setGamma(double value) {
        this.MC.options.getGamma().setValue(value);
    }

    public void setMouseSensitivity(double value) {
        this.MC.options.getMouseSensitivity().setValue(value);
    }
